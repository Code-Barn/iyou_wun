...
Tests cover (**330 total across 7 test modules**; ruff clean):
...
- `FeedSanitizerTests` — XSS sanitization, HTML stripping, URI scheme filtering, auto-linkification, roster telemetry & hex concatenation noise pruning (4)
