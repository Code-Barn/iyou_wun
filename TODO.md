...
- [x] Build author friction inspector and appeal submission helper in `apps/core/moderation.py`
- [x] Create `POST /api/moderation/appeal/` endpoint and context exposure in `apps/core/views.py`
- [x] Add transparent friction notice card and appeal modal in `templates/dashboard.html`
- [x] Surface appeal statements and single-click resolution in `templates/admin/moderation_desk.html` and `apps/core/views_admin.py`
- [x] Add user-tunable shield sensitivity preference in `templates/dashboard.html` and `static/js/circle_feed_filter.js`
- [x] Author test suite in `apps/core/tests/test_moderation_appeals.py` (target: 100% pass)
