...
- **Responsive 3-Column Feed Shell** — Desktop feed renders center stream + right **Discovery Rail** (`_feed_right_rail.html`) with TRENDING TOPICS (24H velocity tags), SOVEREIGN CREATORS (+ Follow), and an ecosystem sponsor unit. Collapses gracefully on mobile; hidden in thread mode.
