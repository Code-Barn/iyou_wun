...
```bash
uv run python manage.py test apps.core   # 335 tests / 7 modules
uv run ruff check .
```

335 unit tests across 7 modules — see [docs/WUN_DEVELOPER_GUIDE.md](docs/WUN_DEVELOPER_GUIDE.md#running-tests) for the breakdown.